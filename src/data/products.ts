...
export const PRODUCTS: Product[] = [
  { id:1,  cat:'Wallets',   name:'Name Wallet (PU)',         meta:'Black·Brown·Tan·Blue',         price:210,  emoji:'👛', type:'wallet',   badge:'BESTSELLER', img:'/products/wallet-black.jpg' },
  { id:2,  cat:'Wallets',   name:'Nexon Wallet',             meta:'Black·Red·Grey·Green·Blue',    price:300,  emoji:'💼', type:'wallet',   img:'/products/wallet-nexon.jpg' },
  { id:3,  cat:'Wallets',   name:'Card Holder',              meta:'Black·Brown·Tan·Blue',         price:160,  emoji:'🪪', type:'card',     img:'/products/card-holder.jpg' },
  { id:4,  cat:'Wallets',   name:'Wallet + Keychain Combo',  meta:'Black·Brown·Tan·Blue',         price:360,  emoji:'🔑', type:'wallet',   badge:'COMBO',      img:'/products/wallet-keychain.jpg' },
  ...
  { id:10, cat:'Pens',      name:'P82 Gold / Silver',        meta:'Premium roller pen',           price:200,  emoji:'🖊', type:'pen',      img:'/products/pen-p82.jpg' },
  ...
  { id:15, cat:'Keychains', name:'Leather Keychain NX',      meta:'Black·Brown·Blue',             price:160,  emoji:'🔑', type:'keychain', img:'/products/keychain-leather.jpg' },
  { id:16, cat:'Keychains', name:'Metal Car Keychain',       meta:'Mahindra·Honda·Hyundai·Tata',  price:360,  emoji:'🚗', type:'keychain', badge:'NEW' },
  { id:17, cat:'Keychains', name:'Pen + Keychain Combo',     meta:'Various styles',               price:300,  emoji:'🎀', type:'keychain', badge:'COMBO',      img:'/products/pen-keychain.jpg' },
  { id:18, cat:'Jewellery', name:'Bar Pendant',              meta:'Gold·Silver·Rose Gold',        price:360,  emoji:'📿', type:'pendant',  badge:'BESTSELLER', img:'/products/pendant-bar.jpg' },
  ...
  { id:21, cat:'Jewellery', name:'Name Kada Bracelet',       meta:'Gold·Black·Silver·Rose Gold',  price:360,  emoji:'📿', type:'bracelet', img:'/products/bracelet-kada.jpg' },
  ...
  { id:26, cat:'Diaries',   name:'Professional Diary + Pen', meta:'Doctor·CA·Lawyer design',     price:700,  emoji:'📔', type:'diary',    badge:'BESTSELLER', img:'/products/diary-pen.jpg' },
  { id:27, cat:'Diaries',   name:'Mini Diary + Pen B6',      meta:'Navy·Brown·Black',             price:500,  emoji:'📖', type:'diary',    img:'/products/diary-mini.jpg' },
  ...
  { id:31, cat:'Bottles',   name:'BT01 Smart Bottle',        meta:'Temperature display, Black',   price:400,  emoji:'🍶', type:'bottle',   badge:'BESTSELLER', img:'/products/bottle-bt01.jpg' },
  { id:32, cat:'Bottles',   name:'Fashion Sport Bottle',     meta:'Vacuum insulated SS',          price:400,  emoji:'🧴', type:'bottle',   img:'/products/bottle-sport.jpg' },
  ...
  { id:35, cat:'Frames',    name:'Wooden Frame',             meta:'5×7·6×8·8×10·12×8 inch',      price:600,  emoji:'🖼', type:'frame',    badge:'CUSTOM',     img:'/products/wooden-frame.jpg' },
  { id:36, cat:'Frames',    name:'Round Wooden Frame',       meta:'6×6·8×8 inch',                price:700,  emoji:'🪞', type:'frame' },
  { id:37, cat:'Frames',    name:'Caricature Standee',       meta:'Custom cartoon, 6/8 inch',     price:800,  emoji:'🎨', type:'frame',    badge:'NEW',        img:'/products/caricature.jpg' },
  { id:38, cat:'Combos',    name:'Wallet + Pen + Keychain',  meta:'Black·Brown·Tan·Blue',         price:400,  emoji:'🎁', type:'wallet',   badge:'BESTSELLER', img:'/products/wpk-combo.jpg' },
  { id:39, cat:'Combos',    name:'3PC Bottle+Pen+Keychain',  meta:'Black premium set',            price:700,  emoji:'📦', type:'bottle',   badge:'CORPORATE',  img:'/products/combo-3pc.jpg' },
